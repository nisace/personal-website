---
title: "Interpretations of correlation and inner product"
description: |
  Interpretations of correlation, inner product and Fourier coefficients.
date: "2026-04-13"
categories: [Signal Processing, Algebra]
---
As seen in the [Cross-correlation, Correlation, Convolution, Inner product and Fourier coefficients](/posts/inner-product-convolution-correlation/index.qmd) blog post, the
$\int_{- \infty}^{\infty}f(t)\overline{g(t)}dt$ quantity for two complex-valued
functions $f$ and $g$ can be seen as:
...
This blog post explores how the above quantity $\langle f,g\rangle = (f \star g)(0) = \int_{- \infty}^{\infty}f(t)\overline{g(t)}dt$ can be interpreted from [Correlation](#correlation) and [Inner product](#inner-product) point of views.
