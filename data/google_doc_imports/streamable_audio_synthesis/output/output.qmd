---
title: "[]{#_7awb6bchetj0 .anchor}Streamable Neural Audio Synthesis With Non-Causal Convolutions"
---
...
- [RAVE: A variational autoencoder for fast and high-quality neural audio synthesis](https://arxiv.org/abs/2111.05011)
  ...
  - This paper introduces the RAVE model which is a [variational autoencoder](https://docs.google.com/document/u/0/d/1bgsMYJV8xzBlf0J-lD0PKpuT3Ylt6hNZNji4Ydzc7t0/edit) trained in two stages:

    - First the regular variational autoencoder training,

    - Followed by an additional adversarial training stage for the decoder.

  - See the [Short introduction to the RAVE model](https://docs.google.com/document/u/0/d/1BRMQoYHJuW6ZTJJnPlWF2dmsEQT6eTYJdEO72k7YPsI/edit) post for more details.
...
- As explained in the [Encoder](https://docs.google.com/document/d/1BRMQoYHJuW6ZTJJnPlWF2dmsEQT6eTYJdEO72k7YPsI/edit?tab=t.0#heading=h.yu3pqxyylwak) section of the [Short introduction to the RAVE model](https://docs.google.com/document/u/0/d/1BRMQoYHJuW6ZTJJnPlWF2dmsEQT6eTYJdEO72k7YPsI/edit) post, the convolution layers usually use padding to maintain the time alignment between the inputs and outputs across layers.
...
>
> $stride\ delay = (stride - A)\ \%\ stride$$stride\ delay = (stride - (Cumulated\ Delay\  + \ right\ pad)\ \%\ stride)\ \%\ stride$
