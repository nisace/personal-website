---
title: "[]{#_pg7b2bwo1ohu .anchor}SoundStream"
---
...
![](data/google_doc_imports/soundstream/output/media/media/image1.png){width="5.734375546806649in" height="2.955194663167104in"}
...
- Residual vector quantizer
  ...
  - Replaces each embedding by its RQV quantization $RQV(e)$
    ...
    - See [Residual Vector Quantization](https://docs.google.com/document/d/1K0ekOqiEsINropgQnt-_4EVDJ957PbxqfF-tzM3oHHk/edit?tab=t.0#heading=h.kfvnxqktbpbj).
...
- The discriminator is composed of two discriminators
  ...
  - STFT-based discriminator ([Short-Term Fourier Transform](?tab=t.je0zv49yt9sx#heading=h.12ox1bw2ten2)).

## Metrics

- [ViSQOL metric](?tab=t.9p08qdk1tgbd#heading=h.t5ub53g3ecm1)
