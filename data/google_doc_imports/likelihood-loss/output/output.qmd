---
title: "[]{#_eydiu1mvc69l .anchor}Maximum Likelihood Estimation and loss functions"
---

In this blog post, we will introduce the concept of Maximum Likelihood Estimation (MLE) and we show that maximizing the likelihood (MLE) of the observed data is equivalent to minimizing:
...
- We can recognize above the expression of the [[cross entropy loss]{.underline}](https://scikit-learn.org/stable/modules/model_evaluation.html#log-loss).
...
- To understand why the formula $- \sum_{i = 1}^{n}\sum_{k = 1}^{C}y_{i,k}\ log\ \widehat{y_{i,k}}$ is called the cross entropy loss, refer to [[Information Theory]{.underline}](https://docs.google.com/document/d/1QfZs6wXeL_WNEX92O4kiL_tRrmlFgsK5ZCI9T1QbBcc/edit?tab=t.0#heading=h.iy4rivwspb0l).
