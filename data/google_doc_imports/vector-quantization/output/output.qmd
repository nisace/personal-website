---
title: "[]{#_do7jj7r9h7k6 .anchor}Vector Quantization (VQ)"
---

# Main idea

This blog post is about Vector Quantization (VQ). The main idea is to:
...
- For $N$ codebook vectors, if we consider all the codebook vectors equally probable,
  ...
  - and the [information content](https://docs.google.com/document/d/1QfZs6wXeL_WNEX92O4kiL_tRrmlFgsK5ZCI9T1QbBcc/edit?tab=t.0#heading=h.bp6e5451lrs1) is $- \log_{x}(\frac{1}{N}) = \log_{x}(N)$.
